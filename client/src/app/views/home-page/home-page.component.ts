...
import {iif, map, Observable, shareReplay, switchMap} from 'rxjs';
    ...
    <ng-container *ngIf="!loading; else showSpinner">
      <mat-sidenav-container class="sidenav-container">
        <mat-sidenav #sidenav class="sidenav" fixedInViewport
          ...
          <mat-nav-list>
            <ng-container *ngIf="isLoggedIn$ | async; else unknownUser">
              <a mat-list-item routerLink="app/portfolio" (click)="sidenav.close()">Портфолио</a>
            </ng-container>
          ...
          <mat-toolbar>
            <div class="container">
              ...
              <div *ngIf="!(isHandset$ | async)" class="top-nav">
                <ng-container *ngIf="isLoggedIn$ | async; else unknownUser">
                  <a routerLink="app/portfolio" mat-button (click)="sidenav.close()">Портфолио
...
export class HomePageComponent implements OnInit {
  ...
  getPortfolioUpcomingDividends() {
    return this.authService.getCurrentUser$()
      .pipe(map(user => user == null ? environment.demoData.username : user.username),
        switchMap((identifier) => this.http.get<Page<PortfolioDividendDto[]>>(`/public/portfolios/${identifier}/dividends?page=0&size=8&sort=recordDate`)),
