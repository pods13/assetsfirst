import {AfterViewInit, ChangeDetectionStrategy, ChangeDetectorRef, Component, EventEmitter, OnInit, ViewEncapsulation} from '@angular/core';
...
@Component({
    ...
    template: `
        <div class="card-header">
            ...
            <mat-select class="group-by-selector" [value]="card.allocatedBy" (valueChange)="onAllocatedByOptionChanged($event)"
        ...
        return {
            tooltip: {
                ...
                formatter: (params: any) => {
                    const price = this.currencyPipe.transform(params.value, params.data.currencyCode);
